...
namespace task_28
{
    ...
    {
        private class MyLLElement<E>
        {
            public E value;
            public MyLLElement<E> next;
            public MyLLElement<E> prev;
            public MyLLElement(E element)
            {
                next = null;
                prev = null;
                value = element;
