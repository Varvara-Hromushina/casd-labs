...
public class Program
{
    ...
    {
        int[] array = { 10, 6, 54, -6, 7, -2, 4, 3 };
        Console.WriteLine("Начальная двунаправленная очередь: ");
        MyArrayDeque<int> deque = new MyArrayDeque<int>(array);
        deque.Print();
        Console.WriteLine();

        Console.WriteLine("Элемент, извлеченный из головы: " + deque.Pop());
        Console.WriteLine("Двунаправленная очередь после извлечения элемента из головы: ");
        deque.Print();
        Console.WriteLine();

        Console.WriteLine("Двунаправленная очередь после добавления элемента: ");
        deque.AddFirst(67);
        deque.RemoveFirst();
        deque.Print();
    }
