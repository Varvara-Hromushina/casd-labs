    ...
    public class Programm
{
    ...
    {
        MyHashMap<int, int> list = new MyHashMap<int, int>();
        for(int i = 0; i< 5; i++)
        {
            list.Put(i, i * 5);
        }
        IEnumerable<KeyValuePair<int, int>> pairs = list.EntrySet();
        ...
        Console.WriteLine("Получим значение, в котором ключ равен 3: " + list.Get(3));
        Console.WriteLine();
