...
namespace task_22
{
    ...
    public class MyHashMap<K, V>
    {
        ...
        {
            return Math.Abs(key.GetHashCode()) % table.Length; //чтобы ограничить хэш-код в диапазоне допустимых индексов массива от 0 до size - 1
        }
        private int GetHashCode(V key) { return Math.Abs(key.GetHashCode()) % table.Length; }
